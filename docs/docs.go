                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.BombResponse"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.BombRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/bombs/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Bomb update data",
                        "name": "bomb",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.BombUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.GameRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/game/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to find specific game",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UserUpdatePayload"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "token : tokenJwt",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/v1/teams/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated team payload",
                        "name": "team",
                        "in": "body",
                        "required": true,
                        "schema": {
